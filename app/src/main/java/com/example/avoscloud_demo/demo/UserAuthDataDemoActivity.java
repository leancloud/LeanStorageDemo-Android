...
//  public void testDisassociateWithAuthData() {
//    showInputDialog("Sign Up", new InputDialogListener(){
//      public void onAction(final String username, final String password) {
//        final AVUser user = new AVUser();
//        user.setUsername(username);
...
//              authData.put("access_token", "DCfafewerEWDWIF");
//              authData.put("platform", "weixin");
//              user.associateWithAuthData(authData, "weixin", new SaveCallback() {
//                @Override
//                public void done(AVException ex) {
//                  if (null != ex) {
//                    log("第三方信息关联失败。 cause：" + ex.getMessage());
//                  } else {
//                    log("第三方信息关联成功. User:" + user.toString());
//                    user.setMobilePhoneNumber("18600345198");
...
//                    }
//                    user.dissociateAuthData("weixin", new SaveCallback() {
//                      @Override
//                      public void done(AVException ex) {
//                        if (null != ex) {
//                          log("第三方信息解除关联失败。 cause：" + ex.getMessage());
//                        } else {
//                          log("第三方信息解除关联成功. User: " + user.toString());
//                        }
//                      }
//                    });
//                  }
